usage(){
	...
	printf "\033[35m$0 \033[32m--action=create-token\033[0m \033[33m--email=myemail@email.com  --data=thisIsAPassword\033[0m\n"
...
help_menu(){
	...
	printf "\033[35mData\t\t\t\033[32m[ --data={EXTRA_DATA}, email:{EXTRA_DATA} ]\033[0m\n"
	printf "\n"
	commands
	printf "\n"
	usage
